...
AURA.Vector2.prototype = {
  ...
  clone : function () {
    return new AURA.Vector2(this.x, this.y);
  },
  ...
  plusNew : function (v) {
     return new AURA.Vector2(this.x+v.x, this.y+v.y); 
  },
